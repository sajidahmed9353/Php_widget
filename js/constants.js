const contractAddress = "0xA58a5ddAe4dab67b2247528d4DabDbd23c4dAEB4"; // Replace with your own contract address
const chain = 'goerli'; // goerli, polygon, or ethereum

const welcome_h1 = "Welcome to the MoM NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Mothers of Matriarchy (MoM) is an NFT project that aims to celebrate the diversity and strength of mothers from around the world.';
